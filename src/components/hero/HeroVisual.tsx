 ...
 * scroll scrub can move them from scattered to composed without touching
...
export function HeroVisual({ labels }: { labels: HeroLabels }) {
  return (
    ...
    >
      ...
      <g stroke="var(--color-brand)" opacity="0.35" strokeWidth="1">
      ...
      {/* dress form */}
      <g fill="var(--color-brand-wash)" stroke="var(--color-brand)" strokeOpacity="0.45">
      ...
      <g className="hero-piece hero-skirt">
        ...
        <g stroke="var(--color-brand)" strokeOpacity="0.55" fill="none">
          <path d="M266 356v70" />
      ...
      <g className="hero-piece hero-waist">
        <path d="M162 290h96l2 10H160Z" fill="var(--color-brand-deep)" />
      </g>
      ...
      <g stroke="var(--color-brand)" strokeOpacity="0.35" fill="none">
