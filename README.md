...
- **Accreditation numbers** — the certificate and trade licence numbers are **not shown anywhere on the site**, by client instruction. The accreditation *statement* (the authority that accredited the institute) is kept on the About page and the homepage institutional section, and "Accredited institute" remains in the hero. The numbers themselves are still held in [src/content/institute.ts](src/content/institute.ts) for tender paperwork, but nothing renders them.
