...
- **Accreditation numbers** — the certificate and trade licence numbers appear on the About page, the homepage institutional section, and in the footer's institute column, which puts them on every page for the donor and tender audience. They are deliberately *not* in the footer's bottom bar, which carries the centred copyright alone. Values live in [src/content/institute.ts](src/content/institute.ts).
